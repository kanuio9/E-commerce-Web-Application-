...
import { filters, singleFilter } from './Product'
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                      ...
                      <>
                        <h3 className="-my-3 flow-root">
                          <Disclosure.Button className="group flex w-full items-center justify-between bg-white py-3 text-sm text-gray-400 hover:text-gray-500">
                            <FormLabel sx={{ color: "black", fontSize: "14px" }} id="demo-radio-buttons-group-label">
                              {section.name}
                            </FormLabel>
                            <span className="ml-6 flex items-center">
                              <PlusIcon aria-hidden="true" className="h-5 w-5 group-data-[open]:hidden" />
                          ...
                          <div className="space-y-4">
                            <FormControl>
                              <RadioGroup
                                ...
                                onChange={(e) => handleRadioFilterChange(e, section.id)} // pass e correctly here
                              >
                                {section.options.map((option, optionIdx) => (
                                  <FormControlLabel
                                    key={optionIdx} // add a key for each option
                                    value={option.value}
                                    control={<Radio />}
                                    label={option.label}
                                  />
              ...
              <div className="lg:col-span-3 w-full">
                <div className='flex flex-wrap justify-center bg-white py-5'>
                  {/* {MenKurta.map((item) => <ProductCard product={item} />)} */}
